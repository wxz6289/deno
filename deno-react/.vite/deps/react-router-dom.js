import { __toESM, require_react } from "./chunk-M5CQWIW2.js";

// node_modules/.deno/react-router-dom@6.12.1/node_modules/react-router-dom/dist/index.js
var React2 = __toESM(require_react());

// node_modules/.deno/react-router@6.12.1/node_modules/react-router/dist/index.js
var React = __toESM(require_react());

// node_modules/.deno/@remix-run+router@1.6.3/node_modules/@remix-run/router/dist/router.js
function _extends() {
...
function getUrlBasedHistory(
  ...
  function createURL(to) {
    let base = window2.location.origin !== "null"
...
function createRouter(init) {
  const routerWindow = init.window
    ...
    ? window
    : void 0;
  const isBrowser2 = typeof routerWindow !== "undefined" &&
  ...
  async function startNavigation(historyAction, location, opts) {
    ...
    if (
      state.initialized && !isRevalidationRequired &&
  ...
  async function handleLoaders(
    ...
    let activeSubmission = submission || fetcherSubmission
      ...
      : loadingNavigation.formMethod && loadingNavigation.formAction &&
          loadingNavigation.formData && loadingNavigation.formEncType
      ? {
    ...
    let shouldUpdateFetchers = updatedFetchers || didAbortFetchLoads ||
      revalidatingFetchers.length > 0;
    return _extends(
      {
        loaderData,
  ...
  async function startRedirectNavigation(state2, redirect3, _temp) {
    ...
    if (
      redirectPreserveMethodStatusCodes.has(redirect3.status) && submission &&
  ...
  function updateBlocker(key, newBlocker) {
    ...
    invariant(
      ...
      "Invalid blocker state transition: " + blocker.state + " -> " +
        newBlocker.state,
    );
...
function normalizeTo(
  ...
  if (
    ...
    activeRouteMatch.route.index && !hasNakedIndexQuery(path.search)
  ) {
...
function isNewRouteInstance(currentMatch, match) {
  ...
  return (
    ...
    currentPath != null && currentPath.endsWith("*") &&
  ...
  for (let lazyRouteProperty in lazyRoute) {
    ...
    warning(
      ...
      'Route "' + routeToUpdate.id + '" has a static property "' +
        ...
        ('The lazy route property "' + lazyRouteProperty +
          '" will be ignored.'),
    );
    if (
      !isPropertyStaticallyDefined && !immutableRouteKeys.has(lazyRouteProperty)
    ) {
...
async function callLoaderOrAction(
  ...
  try {
    ...
    invariant(
      ...
      "You defined " + (type === "action" ? "an action" : "a loader") +
        " for route " +
        ('"' + match.route.id + "\" but didn't return anything from your `" +
          type + "` ") +
  ...
  if (isDeferredData(result)) {
    ...
    return {
      ...
      deferredData: result,
      statusCode: (_result$init = result.init) == null
        ? void 0
        : _result$init.status,
      headers: ((_result$init2 = result.init) == null
        ? void 0
...
function getInternalRouterError(status, _temp4) {
  ...
  if (status === 400) {
    ...
    if (method && pathname && routeId) {
      errorMessage = "You made a " + method + ' request to "' + pathname +
        '" but ' +
    ...
    if (method && pathname && routeId) {
      errorMessage = "You made a " + method.toUpperCase() + ' request to "' +
        pathname + '" but ' +
...
function isDeferredData(value) {
  let deferred = value;
  return deferred && typeof deferred === "object" &&
...
function isResponse(value) {
  return value != null && typeof value.status === "number" &&
    typeof value.statusText === "string" && typeof value.headers === "object" &&
...
function RenderedRoute(_ref) {
  ...
  let dataRouterContext = React.useContext(DataRouterContext);
  if (
    dataRouterContext && dataRouterContext.static &&
...
function _renderMatches(matches, parentMatches, dataRouterState) {
  ...
  if (matches == null) {
    ...
    if (
      (_dataRouterState = dataRouterState) != null && _dataRouterState.errors
    ) {
...
function useBlocker(shouldBlock) {
  ...
  React.useEffect(() => () => router.deleteBlocker(blockerKey), [
    router,
    blockerKey,
  ]);
...
function createRoutesFromChildren(children, parentPath) {
  ...
  React.Children.forEach(children, (element, index) => {
    ...
    let route = {
      ...
      hasErrorBoundary: element.props.ErrorBoundary != null ||
...
function BrowserRouter(_ref) {
  ...
  let setState = React2.useCallback((newState) => {
    START_TRANSITION2 in React2
      ? React2[START_TRANSITION2](() => setStateImpl(newState))
      : setStateImpl(newState);
  }, [setStateImpl]);
